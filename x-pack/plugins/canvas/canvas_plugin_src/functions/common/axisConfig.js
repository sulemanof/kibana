...
export const axisConfig = () => ({
  ...
  fn: (context, args) => {
    ...
    if (!positions.includes(position)) throw functionErrors.axisConfig.positionInvalid(position);
    ...
    if (minVal != null && isNaN(minVal)) throw functionErrors.axisConfig.minInvalid(min);
    if (maxVal != null && isNaN(maxVal)) throw functionErrors.axisConfig.maxInvalid(max);
